<?php
// FROM HASH: 087346e2556aeb99985878099201a975
return array(
...
'thread_list_header' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<h2 class="block-tabHeader tabs">
		<div class="hScroller" data-xf-init="h-scroller">
			<span class="hScroller-scroll">
				...
				<a href="' . $__templater->func('link', array('forums', $__vars['forum'], $__vars['suggestionTabs']['popular']['filters'], ), true) . '" class="tabs-tab ' . ($__vars['suggestionTabs']['popular']['selected'] ? 'is-active' : '') . '">' . 'Popular' . '</a>
				<a href="' . $__templater->func('link', array('forums', $__vars['forum'], $__vars['suggestionTabs']['newest']['filters'], ), true) . '" class="tabs-tab ' . ($__vars['suggestionTabs']['newest']['selected'] ? 'is-active' : '') . '">' . 'Newest' . '</a>
				';
	if ($__vars['suggestionTabs']['implemented']) {
		$__finalCompiled .= '
					<a href="' . $__templater->func('link', array('forums', $__vars['forum'], $__vars['suggestionTabs']['implemented']['filters'], ), true) . '" class="tabs-tab ' . ($__vars['suggestionTabs']['implemented']['selected'] ? 'is-active' : '') . '">' . 'Implemented' . '</a>
				';
	}
	$__finalCompiled .= '
				';
	if ($__vars['suggestionTabs']['yourSuggestions']) {
		$__finalCompiled .= '
					<a href="' . $__templater->func('link', array('forums', $__vars['forum'], $__vars['suggestionTabs']['yourSuggestions']['filters'], ), true) . '" class="tabs-tab ' . ($__vars['suggestionTabs']['yourSuggestions']['selected'] ? 'is-active' : '') . '">' . 'Your suggestions' . '</a>
				';
	}
	$__finalCompiled .= '
				';
	if ($__vars['suggestionTabs']['yourVotes']) {
		$__finalCompiled .= '
					<a href="' . $__templater->func('link', array('forums', $__vars['forum'], $__vars['suggestionTabs']['yourVotes']['filters'], ), true) . '" class="tabs-tab ' . ($__vars['suggestionTabs']['yourVotes']['selected'] ? 'is-active' : '') . '">' . 'Your votes' . '</a>
				';
	}
	$__finalCompiled .= '
				' . '
