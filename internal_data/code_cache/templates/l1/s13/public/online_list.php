	...
	<div class="block-container">
		<h2 class="block-tabHeader tabs hScroller" data-xf-init="h-scroller">
			<span class="hScroller-scroll">
				...
				<a href="' . $__templater->func('link', array('online', null, array('type' => 'robot', ), ), true) . '" class="tabs-tab ' . (($__vars['typeLimit'] == 'robot') ? 'is-active' : '') . '">' . 'Rosey the Advocate' . '</a>
				' . '
			</span>
		</h2>
		';
				...
				if ($__vars['activity']['User']) {
					...
					$__finalCompiled .= '
									<h3 class="contentRow-header">
										' . 'Rosey the Advocate' . $__vars['xf']['language']['label_separator'] . ' ';
