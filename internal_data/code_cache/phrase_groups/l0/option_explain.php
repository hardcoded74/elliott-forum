<?php
return array (
  'option_explain.EWRcarta_autolink' => 'This option limits the number of autolinks per page. (0 to disable, -1 for no limit)',
  'option_explain.EWRcarta_cache' => 'After the allotted time has passed, the cache for that page will be refreshed.<br />(Accepts PHP <a href="http://php.net/manual/en/function.strtotime.php" target="_blank">strtotime</a> values - Use "now" to disable the cache completely)',
  'option_explain.EWRcarta_restricttree' => 'If enabled, the family tree will only show the immediate parent and siblings.',
  'option_explain.EWRcarta_tocnumber' => 'If selected, numbers will be prepended to the links for table of contents.',
  'option_explain.EWRcarta_tocreq' => 'The number of header &lt;h#&gt; tags required to generate a TOC. (0 to disable)',
  'option_explain.EWRcarta_wikiforum' => 'Discussion threads may be created for wiki pages in this forum. (unspecify to disable)',
  'option_explain.EWRcarta_wysiwyg' => 'You may choose to disable full WYSIWYG editing in the wiki.',
  'option_explain.WidgetFramework_indexNodeId' => 'You can choose to have a widget page take over the index page. The option "Index Page Route" will be ignored and it is recommended to leave the option "Home Page URL" blank.',
...
/*$(function()
{
  ...
  'option_explain.registerEmailCustomUserFields' => 'Enter Custom User Field IDs here. Only textbox fields are supported. Separate each Custom User Field ID with a comma.',
  'option_explain.registerEmailEmailFromUsername' => 'Emails will be shown sent by this name.',
  'option_explain.registerEmailEmailTo' => 'Example: example@example.com
<br />
<br />
If you would like to send multiple Register Emails, add them here. Separate each email address with a comma.',
  'option_explain.registerEmailLanguageId' => 'Emails will be sent using this Language ID.',
  'option_explain.registerEmailLocation' => 'Show location based on IP address.',
  ...
  'option_explain.siropu_username_change_forum_id' => 'The forum ID for the forum in which automated username changes announcements will be posted.',
  'option_explain.siropu_username_change_user_id' => 'The user ID of the user that will post the announcements in the announcements forum.',
  'option_explain.siropu_username_change_user_min_days' => 'The minimum number of days a user has to have since registered in order to be able to change the username.',
  'option_explain.siropu_username_change_user_min_posts' => 'The number of posts required in order to be able to change the username.',
